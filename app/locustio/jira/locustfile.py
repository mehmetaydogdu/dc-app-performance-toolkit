...
from extension.jira.extension_locust import app_specific_action_report_page, app_specific_action_issue_view
...
class JiraBehavior(MyBaseTaskSet):
    ...
    def custom_action_issue_view_iframe(self):
        app_specific_action_issue_view(self)
    
    @task(config.percentage('standalone_extension_report_page'))  # By default disabled
    def custom_action_report_page(self):
        app_specific_action_report_page(self)
